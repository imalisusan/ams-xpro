<x-app-layout>
    ...
    <div class="py-12 ">
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <br> 
            <a type="button"  href="{{route('examcard.download' )}}"  style="float:left; margin-left:2%;   "
                            class="px-5 py-2 border-green-500 border text-green-500 rounded transition duration-300 hover:bg-white-700 hover:text-black focus:outline-none place-self-center"> 
